...
```bash
python .cursor/skills/excel-deep-parsing-agent/scripts/run_pipeline.py --help
```
...
```bash
python .cursor/skills/excel-deep-parsing-agent/scripts/run_pipeline.py \
...
```bash
python .cursor/skills/excel-deep-parsing-agent/scripts/export_visuals.py \
  --workbook "D:/designs/ZU1A3-D511ACL017.xls" \
  --output-dir "D:/analysis/retry-visuals"
```

```bash
python .cursor/skills/excel-deep-parsing-agent/scripts/ocr_runner.py \
